-- ============================================
-- 🌙 LUNAR HUB v5.0 (МЕГА КРАСИВЫЙ)
-- by Ryzen | АНИМАЦИИ | СТИЛЬ | СТАБИЛЬНОСТЬ
-- ============================================
...
tabsFrame.Position = UDim2.new(0, 8, 0, 115)
...
-- ЗАПУСК АНИМАЦИЙ И ХАБА
updateList(currentCategory, "")
appearTween:Play()
glowPulse:Play()

print("✅ Lunar Hub v5.0 загружен! (" .. totalGames .. " игр)")
print("🌙 Мега красивые анимации активированы!")
