-- ============================================
-- 🌙 LUNAR HUB v14.0 (СТАБИЛЬНАЯ ВЕРСИЯ)
-- by Ryzen
-- ============================================
...
-- ============================================
-- 🎨 ОТРИСОВКА ИГР (ПРОСТАЯ И НАДЁЖНАЯ)
-- ============================================
...
-- ============================================
-- ⚡ ЗАПУСК (ГЛАВНЫЙ СЕКРЕТ)
-- ============================================
updateFavCount()
updateContent(currentCategory)

-- ============================================
-- 🔥 СЕКРЕТНЫЙ ФИКС (РАБОТАЕТ 100%)
-- ============================================
task.wait(0.2)
searchBox:GetPropertyChangedSignal("Text"):Fire()

print("✅ Lunar Hub v14.0 loaded! (" .. #Games .. " games)")
print("💾 Избранное сохраняется!")
print("⌨️ Горячая клавиша: Ctrl+F")
print("🔥 Стабильная версия активирована!")
