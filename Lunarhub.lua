-- ============================================
-- 🌙 LUNAR HUB v19.0 (СТИЛЬНЫЙ И РАБОЧИЙ)
-- by Ryzen
-- ============================================
...
-- ============================================
-- 📂 КАТЕГОРИИ (ВЕРТИКАЛЬНЫЕ, СТИЛЬНЫЕ)
-- ============================================
...
local function updateContent(category)
    ...
    list.CanvasSize = UDim2.new(0, 0, 0, #gamesToShow * 38 + 10)
end
...
local function showUpdateWindow()
    ...
    updateFrame.Size = UDim2.new(0, 350, 0, 160)
    updateFrame.Position = UDim2.new(0.5, -175, 0.5, -80)
    ...
    updateText.Text = "v19.0 — Стильный и рабочий хаб\n— Чистый дизайн\n— Горячая клавиша Ctrl+F"
...
print("✅ Lunar Hub v19.0 loaded! (" .. #Games .. " games)")
print("⌨️ Горячая клавиша: Ctrl+F")
print("🎨 Стильный дизайн активирован!")
