...
local function selfUpdate()
    local currentVersion = "4.8"  -- ← МЕНЯЙ ЭТУ ЦИФРУ ПРИ ОБНОВЛЕНИИ
...
-- ПЫТАЕМСЯ ПОДКЛЮЧИТЬСЯ К GUI
local success, err = pcall(function()
    screen.Parent = game:GetService("CoreGui")
end)

if not success then
    warn("CoreGui не доступен, пробую PlayerGui")
...
frame.BackgroundColor3 = Color3.fromRGB(14, 14, 34)
...
gradient.Color = ColorSequence.new({
    ...
    ColorSequenceKeypoint.new(1, Color3.fromRGB(14, 14, 34))
})
frame.UIGradient = gradient

-- НЕОНОВАЯ РАМКА (БЕЗ ПУЛЬСАЦИИ, ПРОСТО КРАСИВАЯ)
...
sub.TextColor3 = Color3.fromRGB(180, 180, 230)
sub.TextSize = 13
...
tabsFrame.Position = UDim2.new(0, 8, 0, 78)
...
list.Position = UDim2.new(0, 10, 0, 118)
...
print("✅ Lunar Hub v4.5 загружен! (" .. totalGames .. " игр)")
print("🌙 Улучшенный дизайн активирован!")
