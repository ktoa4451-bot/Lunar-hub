...
-- ПРИНУДИТЕЛЬНЫЙ ЗАПУСК (ИЗ v9.4)
task.wait(0.2)
searchBox.Text = ""
searchBox:GetPropertyChangedSignal("Text"):Fire()

print("✅ Lunar Hub v12.3 loaded! (" .. #Games .. " games)")
