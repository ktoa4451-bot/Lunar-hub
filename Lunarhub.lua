...
-- ПОИСК (ОСТАВЛЯЕМ, НО ОН БУДЕТ РАБОТАТЬ КАК ТРИГГЕР)
...
-- ============================================
-- Мы заставляем поиск "думать", что в него что-то ввели
-- и он создаёт все кнопки при загрузке
task.wait(0.2)
